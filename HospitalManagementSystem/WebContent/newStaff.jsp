...
<div class="leave w3l">
  	...
  	<h3 id="idtosave" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Staff ID : <span>${staff.staffId} </span></h3>      
           <br> <h3 id="1" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Name :<span>${staff.staffName}</span></h3>
...
{
    var textToSave = document.getElementById("idtosave").textContent;
    textToSave += '\n';
