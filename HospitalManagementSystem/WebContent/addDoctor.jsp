		...
		<div class="leave w3l">
			...
			<br>
					...
					<div class="single-grid">
						...
						<form:form action="./NewDoctorController" commandName="doctor">
							<form:input path="doctorId" placeholder="ID"/>
							<form:input path="doctorName" placeholder="Name"/>
							...
							<form:password path="doctorPassword" placeholder="Password"/>
