...
<!--//header-top-->
		...
		<div class="top_banner two">
			<div class="container">
			       <div class="sub-hd-inner">
						<h3 class="tittle">REMOVE <span>STAFF </span></h3>
					</div>
			</div>
		</div>
	<!--/single-->
 <div class="single">
		...
		<div class="leave w3l">
			<h3>Enter <span> Staff ID </span></h3>
			<br>
			<br>
					...
					<div class="single-grid">
						<div class="single-us">
						   ...
						   <form action="./RemoveStaff">
								...
								<input type="text" placeholder="Staff ID to ${button}" required="" name="staffId" id="staffId">
